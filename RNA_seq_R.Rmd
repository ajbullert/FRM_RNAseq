...
**Ether Lipid metabolizing genes**
```{r}
top_gene<-read.csv("gene_list_ether_lipid_kegg.csv", header = FALSE)
top_gene<-as.character(top_gene$V1)
...
```{r}
stat.test<-read.csv("FDR_ether_lipid.csv")
stat.test$symbol<-factor(stat.test$symbol)
stat.test$group2<-as.factor(stat.test$group2)
stat.test$group1<-as.factor(stat.test$group1)
stat.test
...
# Export into pdf: display multiple plots on the same page
ggexport(
  plotlist = plot_list, filename = "ether_lipid_metabolism_gene_plot.pdf", 
  ncol = 1, nrow = 1, height = 7, width = 7, res = 600,pointsize = 8
)
```

**Glycero metabolizing genes**
```{r}
top_gene<-read.csv("gene_list_glycer_metabolism_kegg.csv", header = FALSE)
top_gene<-as.character(top_gene$V1)
...
```{r}
stat.test<-read.csv("FDR_glycer_metabolism.csv")
stat.test$symbol<-factor(stat.test$symbol)
stat.test$group2<-as.factor(stat.test$group2)
stat.test$group1<-as.factor(stat.test$group1)
stat.test
...
# Export into pdf: display multiple plots on the same page
ggexport(
  plotlist = plot_list, filename = "glycero_metabolism_gene_plot.pdf", 
  ncol = 1, nrow = 1, height = 7, width = 7, res = 600,pointsize = 8
)
```
...
**cyp genes**
```{r}
top_gene<-read.csv("gene_list_cyps_kegg.csv", header = FALSE)
top_gene<-as.character(top_gene$V1)
...
```{r}
stat.test<-read.csv("cyps_FDR.csv")
stat.test$symbol<-factor(stat.test$symbol)
stat.test$group2<-as.factor(stat.test$group2)
stat.test$group1<-as.factor(stat.test$group1)
stat.test
...
# Export into pdf: display multiple plots on the same page
ggexport(
  plotlist = plot_list, filename = "cyp_gene_plot.pdf", 
  ncol = 1, nrow = 1, height = 7, width = 7, res = 600,pointsize = 8
)
```